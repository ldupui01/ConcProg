...
* Assuming there is more than one processor in the machine, parallel computations finish earlier.
*/
public class ComputationLauncher {
/**
* How many numbers to process? If too low, there is no noticeable difference.
*/
